...
module.exports = InputView.extend({
	...
	extract: function (e) {
		...
		xhr(
			{
				url:
					config.API_URL[process.env.NODE_ENV] +
					'extract?url=' +
			...
			function (err, resp, body) {
				...
				try {
					...
					self.parseError =
						'Unable to parse the response, please enter the data manually.\n' +
						error;
				}
			}
		);
